...
export LoadConfig_PER_TX
export _LoadConfig_PER_TX
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_PER_TX
	lcall	LoadConfigTBL_PER_TX_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration PER_TX
;
;    Load configuration registers for PER_TX.
...
_LoadConfig_PER_TX:
 LoadConfig_PER_TX:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_PER_TX_Bank0
    mov     X, <LoadConfigTBL_PER_TX_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_PER_TX_Bank1
    mov     X, <LoadConfigTBL_PER_TX_Bank1
