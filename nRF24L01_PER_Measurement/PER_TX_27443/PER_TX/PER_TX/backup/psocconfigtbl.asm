...
export LoadConfigTBL_PER_TX_Bank1
export LoadConfigTBL_PER_TX_Bank0
export LoadConfigTBL_PER_TX_Ordered
AREA lit(rom, rel)
LoadConfigTBL_PER_TX_Bank0:
