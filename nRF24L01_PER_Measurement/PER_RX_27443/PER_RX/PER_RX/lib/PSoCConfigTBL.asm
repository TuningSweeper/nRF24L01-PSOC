...
export LoadConfigTBL_PER_RX_Bank1
export LoadConfigTBL_PER_RX_Bank0
export LoadConfigTBL_PER_RX_Ordered
AREA lit(rom, rel)
LoadConfigTBL_PER_RX_Bank0:
