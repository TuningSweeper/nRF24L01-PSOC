...
export LoadConfig_PER_RX
export _LoadConfig_PER_RX
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_PER_RX
	lcall	LoadConfigTBL_PER_RX_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration PER_RX
;
;    Load configuration registers for PER_RX.
...
_LoadConfig_PER_RX:
 LoadConfig_PER_RX:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_PER_RX_Bank0
    mov     X, <LoadConfigTBL_PER_RX_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_PER_RX_Bank1
    mov     X, <LoadConfigTBL_PER_RX_Bank1
